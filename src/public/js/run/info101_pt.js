...
applicationObs = ``;
applicationObs += createObs(`Painéis suportados:`, `Com soic 24C16`, `820A`);
applicationObs += createObs(`820C`, `820E`, `820R`);
applicationObs += createObs(`821K`, `827N`, `827M`);
applicationObs += createObs(`Com processador 9S12HZ256:`, `823A`, `823K`);
applicationObs += createObs(`826A`, undefined, undefined);
...
{lines: [`Gol G5`, `>Painel Marelli`, `<br /><br />`], help: `Tecle OK`, menu: 1000},
{lines: [`Painel Marelli`, `>soic 24c16`, `<br /><br />`], help: `Tecle OK`, menu: 1000},
...
{lines: [`VW`, `>Gol G5`, `<br /><br />`], help: `Tecle OK`, menu: 1000},
{lines: [`Gol G5`, `>Painel Marelli`, `<br /><br />`], help: `Tecle OK`, menu: 1000},
{lines: [`Painel Marelli`, `>Proc 9S12HZ256`, `<br /><br />`], help: `Tecle OK`, menu: 1000},
{lines: [`Proc 9S12HZ256`, `>Leitura?`, `<br /><br />`], help: `Tecle OK`, menu: 1000},
{lines: [`<br />Carregando...<br />Aguarde<br /><br />`], help: ``},
{lines: [
`&nbsp;Conecte&nbsp;o&nbsp;cabo`,
`&nbsp;MCU&nbsp;no&nbsp;painel`,
