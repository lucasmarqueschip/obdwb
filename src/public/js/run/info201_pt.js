//Capa
nomeCarga = "Programação de chaves Ford Pats 4 Tipo 3 (New Fiesta 13-14 e Ecosport 13-15)";
revCarga = "Rev. 5";
...
{lines: [`PATS 4`, `>Identificar?`, `<br /><br />`], help: `Tecle OK`, menu: 1000},
...
{lines: [`Diagnostico`, `>Ford`, `<br /><br />`], help: `Tecle OK`, menu: 1000},
{lines: [`Ford`, `>PATS 4`, `<br /><br />`], help: `Tecle OK`, menu: 1000},
{lines: [`PATS 4`, `>ECOSPORT 13-15`, `<br /><br />`], help: `Tecle OK`, menu: 1000},
{lines: [`<br />Carregando...<br />Aguarde<br /><br />`], help: ``},
{lines: [
`&nbsp;`,
`Selecione:`,
