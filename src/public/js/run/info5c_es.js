...
description: `Después de conectar todos los accesorios, siga los siguientes pasos en la pantalla del OBDMap:`,
screens: [
{lines: [`Para realizar la programación de llaves, es necesario el PIN del inmovilizador. Si no tiene este PIN, debe realizar la función de Lectura del PIN del inmovilizador IMMO3 via pinza.`], help: `Pulsa OK`, menu: 1000},
{lines: [
`&nbsp;`,
`Introduzca&nbsp;el&nbsp;PIN:`,
`****`,
...
description: `Después de conectar todos los accesorios, siga los siguientes pasos en la pantalla del OBDMap:`,
screens: [
{lines: [`Para borrar las llaves, es necesario el PIN del inmovilizador. Si no tiene este PIN, debe realizar la función de Lectura del PIN del inmovilizador IMMO3 via pinza.`], help: `Pulsa OK`, menu: 1000},
{lines: [
`&nbsp;`,
`Introduzca&nbsp;el&nbsp;PIN:`,
`****`,
