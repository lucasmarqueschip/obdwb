...
{lines: [`Pain Imob6 T2`, `>Fox VDO`, `<br /><br />`], help: `Tecle OK`, menu: 1000},
...
help: `Se for a última chave a ser gravada vá para o Passo 18.`
},
{lines: [
`&nbsp;`,
`&nbsp;Insira&nbsp;e&nbsp;ligue`,
...
help: `Insira e ligue a próxima chave, tecle OK e volte ao Passo 16.`
},
{lines: [
`&nbsp;`,
`Programacao`,
...
help: `Se for a última chave a ser gravada o passo seguinte será o Passo 18.`
},
{lines: [
`&nbsp;`,
`&nbsp;Insira&nbsp;e&nbsp;ligue`,
