...
{lines: [`PLD FR 1`, `>Modelo E`, `<br /><br />`], help: `Tecle OK`, menu: 1000},
{lines: [`Modelo E`, `>Gerar TPD`, `<br /><br />`], help: `Tecle OK`, menu: 1000},
...
help: `Para gerar mais de um transponder insira o próximo no módulo e volte ao Passo 10 ou tecle VOLTAR para finalizar.`
},
{lines: [
`&nbsp;`,
`&nbsp;&nbsp;&nbsp;A&nbsp;PLD&nbsp;esta`,
...
help: `A PLD está provavelmente descodificada`
},
{lines: [
`&nbsp;`,
`Arquivo&nbsp;da`,
...
help: `A PLD está com o arquivo corrompido.`
},
]}
];
//Outras mensagens
