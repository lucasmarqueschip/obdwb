...
{lines: [`Calc 3`, `>Leitura?`, `<br /><br />`], help: `Tecle OK`, menu: 1000},
...
help: `Anote a senha. Esta senha será utilizada na programação de Key Cards.`
},
]
...
{lines: [`Megane Cartao`, `>Prog. chaves?`, `<br /><br />`], help: `Tecle OK`, menu: 1000},
{lines: [`<br />Carregando...<br />Aguarde<br /><br />`], help: ``},
{lines: [
`&nbsp;`,
`Inicie&nbsp;pelo&nbsp;card`,
...
help: `Se optar por iniciar com um card já programado veja observação no fim do manual.`
},
{lines: [
`&nbsp;`,
`Use&nbsp;Card&nbsp;Megane`,
...
help: `Tecle OK para continuar ou tecle Volta
...
help: `Selecione a quantidade de Cards a serem programados.`
},
{lines: [
`&nbsp;`,
`Insira&nbsp;o&nbsp;Card`,
...
help: `Insira o primeiro Card a ser programado.`
},
{lines: [
`&nbsp;`,
`Aguarde...`,
