...
help: `Conecte o cabo USB no OBDMap e no
computador.
Abra o software OBDMap Suite.
Para dúvidas sobre o software clique aqui.`
},
{lines: [
`&nbsp;&nbsp;&nbsp;Utilize&nbsp;o`,
`&nbsp;&nbsp;transponder`,
...
help: `Utilize o transponder ou
telecomando indicado.`
},
{lines: [
`&nbsp;Conecte&nbsp;o&nbsp;cabo`,
`&nbsp;&nbsp;&nbsp;MCU&nbsp;no&nbsp;BC,`,
...
help: `Fazendo a leitura do BC.
Aguarde até completar os 100%.
...
help: `No computador digite um nome para o arquivo
de Backup que seja possível reconhecer de qual
carro pertence. Número de Chassi e/ ou placa
do carro podem ser uma boa opção. Para
dúvidas de como salvar o arquivo clique aqui.`
},
{lines: [
`&nbsp;`,
`Aguarde...`,
...
help: `Sim: apaga todas as chaves.
Não: mantém as chaves já programadas.`
},
{lines: [
`Insira&nbsp;a&nbsp;chave&nbsp;*`,
`a&nbsp;ser&nbsp;programada`,
...
help: `Insira a chave que deseja programar no
módulo de transponder e tecle OK.`
},
{lines: [
`&nbsp;`,
`Aguarde...`,
...
help: `Sim: retorna ao passo 17.
Não: prossiga para o passo 20.
A BC aceita a programação de até 8 chaves.`
},
{lines: [
`&nbsp;`,
`&nbsp;&nbsp;Gravando&nbsp;BC.`,
