//Capa
nomeCarga = "Leitura de Senha GM IMMO5";
revCarga = "Rev. 5";
...
lstFunc = [
`Leitura de senha via pinça e via diagnose.`,
`A leitura de senha via diagnose é possível realizar somente no veículo Cruze, para os demais veículos a leitura de senha é realizada via pinça.`,
...
ballon: "", 
image: "/images/Funções Específicas/OBD0146 Leitura de senha GM Immo 5/Memória 95320/Todos os acessórios conectados 4.jpg"},
];
instruction = [];
obdmap = false;
services = 
...
{lines: [`Imob 5`], help: `Tecle OK`, menu: 1000},
{lines: [`Leitura de senha`], help: `Tecle OK`, menu: 1000},
{lines: [`soic 95320`], help: `Tecle OK`, menu: 1000},
