...
{lines: [`PLD FR 1`, `>Modelo A`, `<br /><br />`], help: `Tecle OK`, menu: 1000},
{lines: [`Modelo A`, `>Gerar TPD`, `<br /><br />`], help: `Tecle OK`, menu: 1000},
...
othersMessage = [{ label: `A PLD esta descodificada!`,
screens: [
`&nbsp;`,
`&nbsp;&nbsp;&nbsp;A&nbsp;PLD&nbsp;esta`,
`&nbsp;descodificada!`,
