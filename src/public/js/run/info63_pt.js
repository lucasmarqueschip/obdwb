//Capa
nomeCarga = `Manual Carga -  OBD0063<br />Leitura Opel 2R (senha)`;
revCarga = `Rev. 3`;
...
{lines: [`GM`, `>Opel 2R`, `<br /><br />`], help: `Tecle OK`, menu: 1000},
{lines: [`Opel 2R`, `>Leitura?`, `<br /><br />`], help: `Tecle OK`, menu: 1000},
