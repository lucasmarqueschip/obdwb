//Capa
nomeCarga = `Manual Carga -  OBD0271<br /> Adaptação de ECU GM Delco E83 com painel Imob4 (Agile-Montana)`;
revCarga = `Rev. 3`;
...
algum defeito físico exista na ECU, Painel
ou no sistema elétrico, o carro não irá
funcionar`
},
]}];
//Outras mensagens
...
othersMessage = [
{ label: `Erro ao salvar arquivo! <OK>`,
screens: [
`&nbsp;`,
`Erro&nbsp;ao&nbsp;salvar`,
`arquivo!&nbsp;&lt;OK&gt;`,
