//Capa
nomeCarga = "Leitura de Senha e Gravação de Chassi VHC";
revCarga = "Rev. 1";
...
{lines: [`GM`, `>Delco VHC`, `<br /><br />`], help: `Tecle OK`, menu: 1000},
{lines: [`Delco VHC`, `>Leitura?`, `<br /><br />`], help: `Tecle OK`, menu: 1000},
...
{lines: [`Diagnostico`, `>GM`, `<br /><br />`], help: `Tecle OK`, menu: 1000},
{lines: [`GM`, `>Delco VHC`, `<br /><br />`], help: `Tecle OK`, menu: 1000},
{lines: [`Delco VHC`, `>Gravar chassi`, `<br /><br />`], help: `Tecle OK`, menu: 1000},
{lines: [`<br />Carregando...<br />Aguarde<br /><br />`], help: ``},
{lines: [
`&nbsp;`,
`Confirma?`,
