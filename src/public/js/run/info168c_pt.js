//Capa
nomeCarga = "Programação de chaves Amarok VDO Imob6 T2";
revCarga = "Rev. 8";
...
`Funções adicionais:`,
`Liberação do painel`,
`Necessita desmontagem do painel e soldagem de 4 fios do cabo MCU para fazer a liberação do painel e programar qualquer chave. `,
`Esta função deve ser usada se não existir nenhuma chave válida do veículo.`,
``,
...
image: "/images/Funções Específicas/OBD0168 Programação de chaves Amarok VDO Imob6 T2/Data de Fabricação do painel.jpg"},
...
image: "/images/Funções Específicas/OBD0168 Programação de chaves Amarok VDO Imob6 T2/Localizando os pontos de soldagem do cabo MCU.jpg"},
...
image: "/images/Funções Específicas/OBD0168 Programação de chaves Amarok VDO Imob6 T2/Localizando os pontos de soldagem do cabo MCU 2.jpg"},

{title: "", 
description: "", 
ballon: "Soldado os fios do cabo MCU na placa do painel.", 
image: "/images/Funções Específicas/OBD0168 Programação de chaves Amarok VDO Imob6 T2/Solda os fios na placa.jpg"},

{title: "Todos os acessórios conectados em bancada:", 
description: "", 
ballon: "", 
image: "/images/Funções Específicas/OBD0168 Programação de chaves Amarok VDO Imob6 T2/Todos os acessórios conectados em bancada.jpg"},
];
instruction = [];
obdmap = false;
services = 
...
description: `Após todos os acessórios conectados, seguir os seguintes passos no visor do OBDMap:`,
screens: [
{lines: [`Antes de fazer a liberação, verificar se é possível gravar a primeira chave utilizando a "Programação de chaves com chave válida" (Página 7).`], help: `Tecle OK`, menu: 1000},

]},{title: `Realizando a restauração do painel`,
description: `Após todos os acessórios conectados, seguir os seguintes passos no visor do OBDMap:`,
screens: [
{lines: [`A restauração do painel é uma função usada para voltar o painel na condição original antes da liberação do painel realizada pelo OBDMAP. Esta operação não é um procedimento padrão e por isso deve ser acompanhada pelo suporte. Por isso é necessária a entrada do código de acesso.`], help: `Tecle OK`, menu: 1000},

]},{title: `Realizando o cancelamento do serviço`,
description: `Após todos os acessórios conectados, seguir os seguintes passos no visor do OBDMap:`,
screens: [
{lines: [`Como a restauração, esse não é um procedimento padrão e deve ser usado somente se houver desistência após já ter feito a liberação do painel. Também será gerado um código de acesso e acompanhado pelo suporte.`], help: `Tecle OK`, menu: 1000},
