//Capa
nomeCarga = "Clonagem das BC’s Fiat (Palio, Siena, Stilo, Strada e Punto) (casamento)";
revCarga = "Rev. 3";
...
{lines: [`BC CODE 2`, `>Clonar?`, `<br /><br />`], help: `Tecle OK`, menu: 1000},
...
othersMessage = [{ label: `Erro na leitura <OK> p/ repetir`,
screens: [
`&nbsp;`,
`Erro&nbsp;na&nbsp;leitura`,
`&lt;OK&gt;&nbsp;p/&nbsp;repetir`,
