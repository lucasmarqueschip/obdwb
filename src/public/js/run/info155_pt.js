...
{lines: [`Mod. Transp.`, `>Clonar 4D`, `<br /><br />`], help: `Tecle OK`, menu: 1000},
{lines: [`Clonar 4D`, `>Kawasaki`, `<br /><br />`], help: `Tecle OK`, menu: 1000},
...
help: `Neste momento OBDMap está realizando a leitura do transponder.`
},
{lines: [
`&nbsp;Insira&nbsp;Transp.`,
`&nbsp;&nbsp;TPX2&nbsp;VIRGEM`,
...
help: `Neste momento o transponder está sendo clonado.`
},
{lines: [
`&nbsp;`,
`Programacao`,
...
help: `O transponder foi clonado com sucesso.`
},
]
...
{lines: [`Outros`, `>Mod. Transp.`, `<br /><br />`], help: `Tecle OK`, menu: 1000},
{lines: [`Mod. Transp.`, `>Clonar 4D`, `<br /><br />`], help: `Tecle OK`, menu: 1000},
{lines: [`Clonar 4D`, `>Yamaha`, `<br /><br />`], help: `Tecle OK`, menu: 1000},
{lines: [`<br />Carregando...<br />Aguarde<br /><br />`], help: ``},
{lines: [
`&nbsp;`,
`Aguarde...`,
