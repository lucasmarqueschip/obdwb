...
help: `O BCM tem o número máximo de chaves programadas.`
},
{lines: [
`&nbsp;`,
`Apagando&nbsp;Chaves!`,
...
help: `Aguarde...
O OBDMap está apagando as chaves antigas.`
},
{lines: [
`&nbsp;Quer&nbsp;realmente`,
`apagar&nbsp;as&nbsp;chaves`,
...
help: `Tecle (OK) SIM para confirmar e apagar as chaves ou (X) NÃO para voltar ao menu anterior.`
},
{lines: [
`&nbsp;`,
`Chave&nbsp;ja&nbsp;esta`,
...
help: `A chave já foi programada ao veículo.`
},
{lines: [
`&nbsp;Conecte&nbsp;o&nbsp;cabo&nbsp;&nbsp;`,
`&nbsp;&nbsp;&nbsp;MCU&nbsp;no&nbsp;BCM,`,
