//Capa
nomeCarga = "Leitura de Senha e Gravação de Chassi - Corsa Flex 1.0";
revCarga = "Rev. 5";
...
description: "A tomada de diagnóstico do veículo fica localizada na área F5.<br /><br />", 
...
{lines: [`GM`, `>Me799 V1 Corsa`, `<br /><br />`], help: `Tecle OK`, menu: 1000},
{lines: [`Me799 V1 Corsa`, `>Leitura?`, `<br /><br />`], help: `Tecle OK`, menu: 1000},
...
{lines: [`Diagnostico`, `>GM`, `<br /><br />`], help: `Tecle OK`, menu: 1000},
{lines: [`GM`, `>Me799 V1 Corsa`, `<br /><br />`], help: `Tecle OK`, menu: 1000},
{lines: [`Me799 V1 Corsa`, `>Gravar chassi`, `<br /><br />`], help: `Tecle OK`, menu: 1000},
{lines: [`<br />Carregando...<br />Aguarde<br /><br />`], help: ``},
{lines: [
`&nbsp;`,
`Digite:*********`,
