//Capa
nomeCarga = `Manual Carga -  OBD0113<br />Reset da M2.10.4 (Marea 2.0 - 98 a 99)`;
revCarga = `Rev. 2`;
...
{lines: [`Fiat`, `>M2.10.4`, `<br /><br />`], help: `Tecle OK`, menu: 1000},
{lines: [`M2.10.4`, `>Resetar?`, `<br /><br />`], help: `Tecle OK`, menu: 1000},
