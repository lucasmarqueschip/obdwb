...
screens: [
{lines: [`VW`], help: `Pulsa OK`, menu: 1000},
{lines: [`Gol`], help: `Pulsa OK`, menu: 1000},
{lines: [`Llaves`], help: `Pulsa OK`, menu: 1000},
{lines: [`Imob 4`], help: `Pulsa OK`, menu: 1000},
{lines: [`Marelli IAW 4GV`], help: `Pulsa OK`, menu: 1000},
{lines: [`Lectura de PIN`], help: `Pulsa OK`, menu: 1000},
{lines: [
`Conecte&nbsp;la&nbsp;pinza&nbsp;en&nbsp;la&nbsp;`,
`memoria&nbsp;95320&nbsp;`,
`Pulsa&nbsp;&lt;OK&gt;`,
`<br />`,
],
...
{lines: [`Llaves`], help: `Pulsa OK`, menu: 1000},
{lines: [`Imob 4`], help: `Pulsa OK`, menu: 1000},
{lines: [`Bosch ME7.5.30`], help: `Pulsa OK`, menu: 1000},
{lines: [`Lectura de PIN`], help: `Pulsa OK`, menu: 1000},
{lines: [
`Conecte&nbsp;la&nbsp;pinza&nbsp;en&nbsp;la&nbsp;`,
`memoria&nbsp;95320&nbsp;`,
...
{lines: [`Llaves`], help: `Pulsa OK`, menu: 1000},
{lines: [`Imob 4`], help: `Pulsa OK`, menu: 1000},
{lines: [`Borrar y Programa llaves`], help: `Pulsa OK`, menu: 1000},
{lines: [
`&nbsp;`,
`Utilice&nbsp;el&nbsp;chip&nbsp;ID&nbsp;48&nbsp;CAN`,
`<br />`,
`<br />`,
],
help: ``,
