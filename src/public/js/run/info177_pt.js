...
{lines: [`Outros`, `>Chrysler`, `<br /><br />`], help: `Tecle OK`, menu: 1000},
{lines: [`Chrysler`, `>Skim 2`, `<br /><br />`], help: `Tecle OK`, menu: 1000},
{lines: [`Skim 2`, `>Gerar TPD`, `<br /><br />`], help: `Tecle OK`, menu: 1000},
...
help: `Mostra quantas chaves estão programadas no imobilizador. Tecle OK`
},
{lines: [
`Deseja&nbsp;manter&nbsp;as`,
`&nbsp;&nbsp;&nbsp;chaves&nbsp;ja`,
...
help: `Geração de transponders realizada com sucesso.`
},
{lines: [
`&nbsp;&nbsp;Gerar&nbsp;outra`,
`&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;chave?`,
...
help: `Para programar mais chaves tecle OK, ou tecle Voltar para finalizar o procedimento.`
},
{lines: [
`&nbsp;`,
`Use&nbsp;transponder`,
