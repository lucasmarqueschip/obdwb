...
{lines: [`Mod. Transp.`, `>Dedicar T5`, `<br /><br />`], help: `Tecle OK`, menu: 1000},
...
help: `Escolha qual montadora deseja dedicar o T5.
-GM
-VW`
},
{lines: [
...
help: `Insira o transponder T5 no módulo de transponder e tecle OK.`
},
{lines: [
`&nbsp;`,
`&nbsp;Grav.&nbsp;T5/Nova`,
...
help: `Para gerar mais de um transponder insira o próximo no módulo  
tecle <OK> e volte ao passo 4 ou tecle voltar para finalizar.`
},
]}
];
//Outras mensagens
