...
{lines: [`Outros`, `>BMW`, `<br /><br />`], help: `Tecle OK`, menu: 1000},
{lines: [`BMW`, `>Imob M1`, `<br /><br />`], help: `Tecle OK`, menu: 1000},
...
help: `Número de chaves que já estão programadas na motocicleta.
Obs: Não é possível apagar chaves.`
},
{lines: [
`&nbsp;Insira&nbsp;transp.`,
`&nbsp;PCF7936&nbsp;virgem`,
...
help: `Momento em que é feito a gravação no transponder.
Aguarde!`
},
{lines: [
`&nbsp;`,
