//Capa
nomeCarga = "Apagar e programar Nissan Nats 6 Proximity (With Key) (chaves)";
revCarga = "Rev. 2";
...
`<obs>`,
`Atenção: `,
`Para que seja possível realizar a função de programação do telecomando, o transponder deve estar codificado no BC. (Carga não inclusa)`,
`Observações:`,
`1. Para realizar a programação do telecomando, é necessário que ele esteja dentro do veículo;`,
`2. Se houver um segundo telecomando, o mesmo deve estar longe do veículo durante a programação, não pode haver 2 telecomandos no próximo ao veículo durante o procedimento, somente um de cada vez;`,
`3. Em alguns casos, o mesmo telecomando poderá ser programado em dois ou mais veículos;`,
`4. Para realizar a programação é necessário inserir a chave válida na ignição do veículo.`,
...
{lines: [`Nats 6`, `>Prog Proximity`, `<br /><br />`], help: `Tecle OK`, menu: 1000},
