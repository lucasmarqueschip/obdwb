//Capa
nomeCarga = `Manual Carga -  OBD0256<br />Dedicação de Transponder ID48 para TP24 (Skoda)`;
revCarga = `Rev. 1`;
...
{lines: [`Outros`, `>Skoda`, `<br /><br />`], help: `Tecle OK`, menu: 1000},
{lines: [`Skoda`, `>ID 48`, `<br /><br />`], help: `Tecle OK`, menu: 1000},
...
{lines: [`Outros`, `>Skoda`, `<br /><br />`], help: `Tecle OK`, menu: 1000},
{lines: [`Skoda`, `>ID 48`, `<br /><br />`], help: `Tecle OK`, menu: 1000},
{lines: [`ID 48`, `>Dedicar`, `<br /><br />`], help: `Tecle OK`, menu: 1000},
{lines: [`<br />Carregando...<br />Aguarde<br /><br />`], help: ``},
{lines: [
`&nbsp;Insira&nbsp;Transp.`,
`&nbsp;ID48&nbsp;virgem&nbsp;no`,
