//Capa
nomeCarga = `Manual Carga -  OBD0081<br />Sprinter - Correção Start Error / Casamento`;
revCarga = `Rev. 3`;
...
{lines: [`Pinca`, `>Mercedes`, `<br /><br />`], help: `Tecle OK`, menu: 1000},
{lines: [`Mercedes`, `>Sprinter`, `<br /><br />`], help: `Tecle OK`, menu: 1000},
{lines: [`Sprinter`, `>Star Error`, `<br /><br />`], help: `Tecle OK`, menu: 1000},
