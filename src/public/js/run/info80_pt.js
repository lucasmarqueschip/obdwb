//Capa
nomeCarga = `Manual Carga -  OBD0080<br />Sprinter - Leitura e Gravação de Chassi (casamento)`;
revCarga = `Rev. 4`;
...
{lines: [`Sprinter`, `>Ler/Grav VIN`, `<br /><br />`], help: `Tecle OK`, menu: 1000},
...
help: `Pressione VOLTA para sair ou pressione OK para modificar o chassi atual.`
},
{lines: [
`&nbsp;Digite&nbsp;o&nbsp;novo`,
`&nbsp;chassi&nbsp;apartir`,
...
help: `Digite o número do chassi. Tecle OK!`
},
{lines: [
`&nbsp;`,
`&nbsp;Gravando&nbsp;ECU.`,
