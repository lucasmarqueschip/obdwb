//Capa
nomeCarga = "Reset e Descodificação Fiat ME7.3H4 Final 688 via OBD (Boot)";
revCarga = "Rev. 1";
...
`Descodificação da ECU Fiat híbrida 0 261 206 688: A descodificação da ECU consiste em desabilitar o seu sistema de imobilizador interno, de forma que a mesma funcione sem a necessidade de transponders, funcionando somente com a chave mecânica.`,
`<obs>`,
...
{lines: [`Fiat Code 2`], help: `Tecle OK`, menu: 1000},
{lines: [`Bosch Me7.3H4`], help: `Tecle OK`, menu: 1000},
{lines: [`Final 688`], help: `Tecle OK`, menu: 1000},
