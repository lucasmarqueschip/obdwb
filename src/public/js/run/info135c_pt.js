//Capa
nomeCarga = `Manual Carga -  OBD0135<br />Leitura de Senha e Programação de Chaves Chery Immo 1 via OBD`;
revCarga = `Rev. 3`;
...
applicationObs = ``;
applicationObs += createObs(`Observação:`, `Só é possível realizar a leitura de senha nos veículos que possuem a ECU ME7.9.7. <br/>Caso o veículo possua uma chave válida, deve-se realizar a identificação da mesma, através da carga básica do Módulo de Transponder, para saber se o veículo utiliza o ID40 ou o ID46.`, undefined);
...
description: ``, 
ballon: `Utilize o transponder ID46 Chery. A dedicação desse transponder pode ser feita pelas cargas OBD0249 ou WOBD0027`, 
image: `/images/Transponders/ID46 Chery.jpg`},

{title: ``, 
description: ``, 
ballon: ``, 
image: `/images/Transponders/TPD_OK/ID 40.jpg`},
...
{lines: [`Face`], help: `Tecle OK`, menu: 1000},
{lines: [`Chaves`], help: `Tecle OK`, menu: 1000},
{lines: [`Bosch ME7.9.7`], help: `Tecle OK`, menu: 1000},
