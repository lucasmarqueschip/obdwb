...
{lines: [`VW`, `>Telecomando 1`, `<br /><br />`], help: `Tecle OK`, menu: 1000},
{lines: [`Telecomando 1`, `>New Beetle`, `<br /><br />`], help: `Tecle OK`, menu: 1000},
{lines: [`New Beetle`, `>Prog. telecmd?`, `<br /><br />`], help: `Tecle OK`, menu: 1000},
...
{lines: [`Selecione`, `>Diagnostico`, `<br /><br />`], help: `Tecle OK`, menu: 1000},
{lines: [`Diagnostico`, `>VW`, `<br /><br />`], help: `Tecle OK`, menu: 1000},
{lines: [`VW`, `>Painel Beetle`, `<br /><br />`], help: `Tecle OK`, menu: 1000},
{lines: [`Painel Beetle`, `>Prog. chaves?`, `<br /><br />`], help: `Tecle OK`, menu: 1000},
{lines: [`<br />Carregando...<br />Aguarde<br /><br />`], help: ``},
{lines: [
`&nbsp;`,
`Ligue&nbsp;a&nbsp;chave`,
...
{lines: [`Diagnostico`, `>VW`, `<br /><br />`], help: `Tecle OK`, menu: 1000},
{lines: [`VW`, `>Painel Beetle`, `<br /><br />`], help: `Tecle OK`, menu: 1000},
{lines: [`Painel Beetle`, `>Leitura?`, `<br /><br />`], help: `Tecle OK`, menu: 1000},
{lines: [`<br />Carregando...<br />Aguarde<br /><br />`], help: ``},
{lines: [
`&nbsp;`,
`Ligue&nbsp;a&nbsp;chave`,
...
{lines: [`Diagnostico`, `>VW`, `<br /><br />`], help: `Tecle OK`, menu: 1000},
{lines: [`VW`, `>Painel Beetle`, `<br /><br />`], help: `Tecle OK`, menu: 1000},
{lines: [`Painel Beetle`, `>Apagar falhas?`, `<br /><br />`], help: `Tecle OK`, menu: 1000},
{lines: [`<br />Carregando...<br />Aguarde<br /><br />`], help: ``},
{lines: [
`&nbsp;`,
`Ligue&nbsp;a&nbsp;chave`,
...
help: `Digite a senha lida do veiculo com o
procedimento de Leitura da Senha.`
},
]
}, {title: `Realizando a programação de telecomando:`,
description: `Após todos os acessórios conectados, seguir os seguintes passos no visor do OBDMap:`,
...
help: `Anote a senha, ela será usada na função
de programação de chaves.`
},
]
}, {title: `Apagando falhas do Painel`,
description: `Após todos os acessórios conectados, seguir os seguintes passos no visor do OBDMap:`,
...
help: `Após essa mensagem, apresente todas as chaves na ignição.`
},
]}
];
//Outras mensagens
