...
{lines: [`Clip`, `>Renault`, `<br /><br />`], help: `Press OK`, menu: 1000},
{lines: [`Renault`, `>Clio II - Calc`, `<br /><br />`], help: `Press OK`, menu: 1000},
{lines: [`Clio II - Calc`, `>Read?`, `<br /><br />`], help: `Press OK`, menu: 1000},
...
{lines: [`Diagnosis`, `>Renault`, `<br /><br />`], help: `Press OK`, menu: 1000},
{lines: [`Renault`, `>Clio II - Calc`, `<br /><br />`], help: `Press OK`, menu: 1000},
{lines: [`Clio II - Calc`, `>Prog. Key?`, `<br /><br />`], help: `Press OK`, menu: 1000},
{lines: [`<br />Loading...<br />Please<br /><br />`], help: ``},
{lines: [
`&nbsp;`,
`Enter&nbsp;the&nbsp;PIN:`,
...
othersMessage = [{ label: `Reading Error!`,
screens: [
`<br />`,
`Reading&nbsp;Error!`,
`<br />`,
