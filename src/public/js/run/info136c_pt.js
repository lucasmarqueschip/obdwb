//Capa
nomeCarga = "Programação da 1ª Chave Toyota Immo 3";
revCarga = "Rev. 6";
...
description: "Para ter acesso ao imobilizador é preciso desmontar o painel do veículo. Siga as instruções abaixo:<br /><br />Por segurança, desconecte a bateria do veículo.<br /><br />", 
...
description: "", 
ballon: "A desmontagem do painel da Rav 4 é semelhante ao da Hilux, o imobilizador se encontra entre o feltro e a caixa de ar como indica a seta, porém em uma posição que dificulta sua retirada.", 
...
description: "", 
ballon: "Desmonte a capa de proteção do volante para ter acesso ao imobilizador do Etios.", 
...
description: "", 
ballon: "Área de soldagem do cabo MCU. (Memória S93C66)", 
...
{title: "", 
description: "", 
ballon: "Identificando os pontos a serem soldados os fios do cabo MCU:<br />1 => Fio Amarelo<br />2 => Fio Vermelho<br />3 => Fio Preto<br />4 => Fio Azul<br />5 => Fio Roxo<br />6 => Fio Cinza", 
...
{title: "", 
description: "", 
ballon: "Cabo MCU conectado no imobilizador.", 
...
{lines: [`Programação da primeira chave`], help: `Tecle OK`, menu: 1000},
